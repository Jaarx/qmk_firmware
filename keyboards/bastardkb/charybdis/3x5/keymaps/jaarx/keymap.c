...
#define LAYOUT_LAYER_RSYMBOL                                                                  \
    _______________DEAD_HALF_ROW_______________, KC_GRV,   KC_PLUS,   KC_MINS,   KC_ASTR,  LT(2, KC_QUOT), \
    ______________HOME_ROW_GACS_L______________, XXXXXXX,   KC_EQL,   KC_UNDS,   KC_LT,  KC_GT, \
